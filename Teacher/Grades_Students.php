                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="Grades2nd[]" min="60" max="99" data-maxlength="2" oninput="this.value=this.value.slice(0,this.dataset.maxlength);if (this.value=='') this.value=60" value="<?= $grade ?>">
                                </td>
                            </tr>
                    <?php
                        }
