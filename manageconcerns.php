...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <!--font-->
    <link rel="stylesheet" href="manageconcerns.css">
            ...
            <div class="topbar">
                ...
                <div class="main1">
                    ...
                    <div class="bsinfo">
                        ...
                        <label for="Complaints">Reason for Complaints</label>
                    ...
                    <div class="content">
                        <div class="coninfo">
                            <div id="textarea">
                                <p><label for="statemen" style="margin-left: 220px;"><strong>Description</strong></label></p>
  <textarea id="statement" name="statemen" rows="32" cols="65" style=" box-shadow: 5px 5px 5px rgb(139, 134, 134);">name:william  date: august  section : bsit  cLorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
    ...
    non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</textarea>
                        ...
                        <div class="coninfo1">
                            ...
                            <button class="btnn">Cancel</button>
