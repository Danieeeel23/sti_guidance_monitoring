...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <!--font-->
    <link rel="stylesheet" href="Lists_of_Violation.css">
    ...
    <title>Lists of Violation</title>
</head>
<body>
    <div class="container">
                    ...
                    <table id="myDataTable" class="hover" style="margin-left: 80px;">
                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                <td><?= $violation['Type_of_Offense']; ?></td>
