            ...
            <div class="topbar">
                      ...
                      <?php 
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $student)
                            {
                                ?>
                        <span class="create">
                            <a href="Manage_Concerns.php?id=<?= $student['Student_ID']; ?>"><input type="submit" value="Create"></a>
                        </span>
                ...
                <div class="card-header">
                    <table id="myDataTable" class="hover" style="margin-left: 80px;">
                        ...
                        <?php 
                            $student_id = $_SESSION['student_id'];
                            $query = "SELECT * FROM `concerns` WHERE Student_ID='$student_id'";
                            $query_run = mysqli_query($link, $query);
                ...
                $('#delete_records').on('click', function(e) { 
	                ...
	                if(employee.length <=0)  {  
		                ...
		                if(checked == true) {			
			                ...
			                $.ajax({ 
                                type: "POST",  
                                url: "delete_student_concern.php",  
                                cache:false,  
