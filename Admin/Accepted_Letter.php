...
<head>
    ...
    <title>Accepted Excuse Letter</title>
</head>
<body>
    <div class="container">
                ...
                <div class="card-header">
                    <table id="myDataTable" class="hover" style="margin-left: 80px;">
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM `excuse letter` WHERE `Status`='Accepted'";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $excuse)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="Update_Accepted_Letter.php?id=<?= $excuse['Excuse_Letter_ID']; ?>"><button type="submit" class="btn btn-update">Update</button></a></td>
                                    </tr>
                                    <?php
                                }
                            }
