                    ...
                    <div class="content">
                        <div class="coninfo">
                            <div id="textarea">
                                ...
                                <textarea id="statement" name="statemen" rows="32" cols="65" style="margin-top: 25px; box-shadow: 5px 5px 5px rgb(139, 134, 134);" required><?php echo $excuse['Description']; ?></textarea>
                            </div>
                        </div>
                        <div class="coninfo1">
                            <label for="Image" name ="Image">Image</label>
                            <!--<input type="image" style="border-style:outset" height="560" width="470"/>--> 
                            <img id="file" src="<?php echo "../Uploads/".$excuse['Images']; ?>" name="file" style="border-style:outset; margin-top: 33px;" height="560" width="470"/>
                            <input type="file" id="inputFile" style="margin-top: 15px;" name="file" onchange="readURL(this);" /> <button type="button" onclick="removeImg()" style="margin-left: 118px; margin-bottom: 20px;">Remove Image</button>
                            <input type="submit" class="btnn" name="update_rejected_letter" value="Update" style="width: 150px; height: 30px; margin-top: 5px; margin-left: 320px; font-size: 15px;">
                        </div>
                    </div>
                </form>
                <?php
